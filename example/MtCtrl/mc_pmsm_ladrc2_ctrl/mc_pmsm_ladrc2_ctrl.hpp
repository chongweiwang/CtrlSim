...
#ifndef _MC_PMSM_LADRC2_CTRL_HPP_
#define _MC_PMSM_LADRC2_CTRL_HPP_
...
#include "../../../lib/controller/adrc/ladrc_2st.hpp"



class McPmsmLadrc2Ctrl : public SimObj
{



public:
    explicit McPmsmLadrc2Ctrl(SimObj *parent = nullptr);
